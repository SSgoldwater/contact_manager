class EmailAddressesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { if contact.is_a?(Person)
                      redirect_to person_path(contact), notice: 'Email address was successfully destroyed.'
                    elsif contact.is_a?(Company)
                      redirect_to company_path(contact), notice: 'Email address was successfully destroyed.'
                    end
                    }
