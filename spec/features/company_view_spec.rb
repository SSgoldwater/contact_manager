...
describe 'the company view', type: :feature do
    let(:company) { Company.create(name: "Comcast") }

  describe 'phone numbers' do


    before(:each) do
      Company.create(name: "Comcast")
  ...
  describe 'email addresses' do
    before(:each) do
      Company.create(name: "Comcast")
      company.email_addresses.create(address: "abc@xyz.com")
      company.email_addresses.create(address: "123@987.com")
      visit company_path(company)
    end
    ...
    it 'adds a new email address' do
      ...
      page.fill_in('Address', with: 'hello@goodbye.com')
      page.click_button('Create Email address')
      expect(current_path).to eq(company_path(company))
      expect(page).to have_content('hello@goodbye.com')
    end
    ...
    it 'edits an email address' do
      ...
      first(:link, 'edit').click
      page.fill_in('Address', with: 'yes@no.com')
      page.click_button('Update Email address')
      expect(current_path).to eq(company_path(company))
      expect(page).to have_content('yes@no.com')
